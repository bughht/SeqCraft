...
| [`matlab/`](matlab/) | The same small GRE 2D built two ways with official MATLAB Pulseq events: direct `LogicBlock` assembly and an example-only `Module`. Both compile through Python and return `mr.Sequence`. |
