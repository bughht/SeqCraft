...
def test_a_trigger_may_overlap_a_readout(system, opts) -> None:
    """
...
def test_a_trigger_is_never_split(system, opts) -> None:
...
def test_two_triggers_need_no_boundary_between_them(system, opts) -> None:
    """
...
def test_a_trigger_alongside_an_rf_and_a_gradient(system, opts) -> None:
...
def test_a_digital_output_is_treated_the_same(system, opts) -> None:
    ...
    compiled = sc.compile(tree, system)
    assert compiled.check().ok, compiled.check()


def test_a_trigger_covering_a_whole_gap_is_a_clear_error(system, opts) -> None:
    """
...
def test_a_barrier_inside_a_trigger_is_rejected(system, opts) -> None:
...
def test_a_barrier_inside_an_rf_is_rejected(system, opts) -> None:
...
def test_a_barrier_inside_an_adc_is_rejected(system, opts) -> None:
...
def test_a_barrier_at_a_trigger_edge_is_fine(system, opts) -> None:
